        ...
        if update.message.photo:
            ...
            if img_hash in media_hashes:
                try:
                    ...
                    print(f"Failed to delete photo message: {e}")
            else:
            ...
            if update.message.video.thumbnail:
                ...
                if img_hash in media_hashes:
                    try:
                        ...
                        print(f"Failed to delete video message: {e}")
                else:
                    media_hashes.add(img_hash)
            ...
            if file_hash in media_hashes:
                try:
                    await update.message.delete()
                    await context.bot.send_message(chat_id=update.effective_chat.id, text="Duplicate document deleted!")
                except Exception as e:
                    print(f"Failed to delete document message: {e}")
            else:
